...
async function getObjects () {
  ...
  await op.fill(2329,11559,true)
  await op.fill(2068,21774,false)

  return { actual, reference, state, tests: validators.tests }
}

function runTests () {
  test('Invalid start 10793', async t => {
    ...
    try {
      ...
      t.fail(err, 'Invalid start 10793')
    }
    t.end()
  })
}
...
// @FUZZ_SIGNATURE e3dae39f94559a951dda2e6b590a1a8f4017a884d960e717f7579004bde8f38a
